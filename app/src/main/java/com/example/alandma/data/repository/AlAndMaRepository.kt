// app/src/main/java/com/example/alandma/data/repository/AlAndMaRepository.kt
 ...
 * Mapping between Entity <-> DTO now includes groupId, createdBy, and updatedBy.
 */
...
//   private val local: LocalRepository,
//   private val remote: RemoteRepository,
//   private val auth: AuthRepository       // to fetch current userId & groupId
// ) {
//   fun getAllTodayTasks() = flow {
//     val groupId = auth.currentGroupId()
//     local.getAllTodayTasks(groupId).collect { emit(it) }
//   }
...
//       dueDateMillis = entity.dueDateMillis
//     )
//     remote.createOrUpdateTodayTask(dto.groupId, dto)
//   }

//   suspend fun deleteTodayTask(entity: TodayTaskEntity) {
//     local.deleteTodayTask(entity)
//     remote.deleteTodayTask(entity.groupId, entity.id, entity.updatedBy)
//   }

//   // … analogous for events, bucketItems, spiritualEntries, dreams …
// }
